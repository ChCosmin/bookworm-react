...
class BookForm extends React.Component {
  ...
  render() {
    ...
    const description = data.description !== undefined ? data.description : "Loading..."
    return (
      <Segment padded>
          ...
          <Grid columns="equal" stackable divided>
            <Grid.Row>
              ...
              <Grid.Column>
                ...
                <div align="center">
                  <a target="_blank" href={data.link}>Go to book page</a>
                </div>
              </Grid.Column> 
            </Grid.Row> 
            ...
            <Grid.Row>
              <Grid.Column>
                <label htmlFor="description"><b>Book description</b></label>
                <Segment size="mini">
